...
<head>
    ...
    <style>
        ...
        .highlight-left img.highlight-icon {
            margin-top: 80px;
            width: 235px;
            height: auto;
        }
    ...
    <div class="container">
        ...
        <div class="brief">
            ...
            <div class="brief-text">
                ...
                <p>
                    Reka Nawa Dwelling (RND) adalah perusahaan di bidang Arsitektur, Kontraktor dan Pengembangan Properti.
                    Kami menghadirkan solusi terpadu dalam perencanaan, pelaksanaan, dan optimalisasi aset properti,
                    dengan fokus pada kualitas, ketepatan waktu, dan nilai berkelanjutan.
                </p>
                <p>
                    Didukung oleh tim profesional yang kompeten, RND berkomitmen menjadi mitra strategis dalam mewujudkan
                    ruang yang fungsional, estetis, dan bernilai ekonomi tinggi.
                </p>
            </div>
        </div>
        ...
        <div class="highlight-section">
            <div class="highlight-left">
                ...
                <img src="{{ asset('assets/images/LoGoo.png') }}" alt="Desain Icon" class="highlight-icon">
            </div>
